...
class PointsToCostmap {
  public:
     ...
     * @return 计算得到的代价地图矩阵
     */
    Eigen::MatrixXf makeCostmapFromPoints(const double maximum_height_thres, const double minimum_height_thres,
  ...
  private:
    ...
    assignPoints2GridCell(const pcl::PointCloud<pcl::PointXYZ> &in_sensor_points);
