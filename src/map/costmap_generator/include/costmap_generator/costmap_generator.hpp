...
private:
  ...
  rclcpp::Publisher<grid_map_msgs::msg::GridMap>::SharedPtr pub_costmap_;      ///< 代价地图发布者
   ...
   */
  void publishCostmap(
    const GridMap & costmap, const geometry_msgs::msg::TransformStamped & tf);
   ...
   */
  Eigen::MatrixXf generatePointsCostmap(
    const sensor_msgs::msg::PointCloud2::SharedPtr & in_points, const double vehicle_to_map_z);
