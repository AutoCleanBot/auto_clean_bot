...
namespace transform
{
    Transform::Transform() : Node("transform")
    {
        ...
        RCLCPP_INFO(this->get_logger(), "Broadcasting static transform from %s to %s",
                    gnss_frame_id_.c_str(), lidar_frame_id_.c_str());
    }

    void Transform::InitParams()
    {
        // 声明参数
        this->declare_parameter("gnss_frame_id", "gnss_link");
        ...
        // 打印参数
        RCLCPP_INFO(this->get_logger(), "gnss_frame_id: %s", gnss_frame_id_.c_str());
    ...
    void Transform::BroadcastTransform()
    {
        ...
        static_transform.header.frame_id = gnss_frame_id_;
