...
#ifndef LIDAR_IMU_INIT__MSG__DETAIL__POSE6_D__STRUCT_HPP_
#define LIDAR_IMU_INIT__MSG__DETAIL__POSE6_D__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__lidar_imu_init__msg__Pose6D __attribute__((deprecated))
#else
# define DEPRECATED__lidar_imu_init__msg__Pose6D __declspec(deprecated)
#endif
...
struct Pose6D_
{
  ...
  // pointer types
  using RawPtr =
    lidar_imu_init::msg::Pose6D_<ContainerAllocator> *;
  using ConstRawPtr =
    const lidar_imu_init::msg::Pose6D_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      lidar_imu_init::msg::Pose6D_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__lidar_imu_init__msg__Pose6D
    std::shared_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__lidar_imu_init__msg__Pose6D
    std::shared_ptr<lidar_imu_init::msg::Pose6D_<ContainerAllocator> const>
...
using Pose6D =
  lidar_imu_init::msg::Pose6D_<std::allocator<void>>;
...
#endif  // LIDAR_IMU_INIT__MSG__DETAIL__POSE6_D__STRUCT_HPP_
