...
#include "lidar_imu_init/msg/detail/pose6_d__rosidl_typesupport_fastrtps_c.h"
...
using _Pose6D__ros_msg_type = lidar_imu_init__msg__Pose6D;
...
size_t get_serialized_size_lidar_imu_init__msg__Pose6D(
  const void * untyped_ros_message,
...
static uint32_t _Pose6D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lidar_imu_init__msg__Pose6D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lidar_imu_init
size_t max_serialized_size_lidar_imu_init__msg__Pose6D(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_lidar_imu_init__msg__Pose6D(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_imu_init, msg, Pose6D)() {
