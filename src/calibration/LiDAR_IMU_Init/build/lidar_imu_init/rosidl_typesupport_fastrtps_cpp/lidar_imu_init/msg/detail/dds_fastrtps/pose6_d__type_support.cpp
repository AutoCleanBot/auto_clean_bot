...
#include "lidar_imu_init/msg/detail/pose6_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const lidar_imu_init::msg::Pose6D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_imu_init::msg::Pose6D *>(
    untyped_ros_message);
...
{
  return &lidar_imu_init::msg::typesupport_fastrtps_cpp::_Pose6D__handle;
}
