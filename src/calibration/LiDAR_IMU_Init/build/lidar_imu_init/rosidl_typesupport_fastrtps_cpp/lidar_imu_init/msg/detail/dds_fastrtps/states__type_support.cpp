...
#include "lidar_imu_init/msg/detail/states__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lidar_imu_init::msg::States & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: vel_end
  {
    cdr << ros_message.vel_end;
  }
  // Member: bias_gyr
  {
    cdr << ros_message.bias_gyr;
  }
  // Member: bias_acc
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lidar_imu_init::msg::States & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: rot_end
  {
    ...
    size_t item_size = sizeof(ros_message.rot_end[0]);
  ...
  // Member: pos_end
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.pos_end[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: vel_end
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.vel_end[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: bias_gyr
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.bias_gyr[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: bias_acc
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.bias_acc[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: gravity
...
{
  auto typed_message =
    static_cast<const lidar_imu_init::msg::States *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_imu_init::msg::States *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_lidar_imu_init
const rosidl_message_type_support_t *
get_message_type_support_handle<lidar_imu_init::msg::States>()
{
  return &lidar_imu_init::msg::typesupport_fastrtps_cpp::_States__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_imu_init, msg, States)() {
  return &lidar_imu_init::msg::typesupport_fastrtps_cpp::_States__handle;
}
