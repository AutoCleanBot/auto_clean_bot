...
{
  new (message_memory) lidar_imu_init::msg::Pose6D(_init);
}

void Pose6D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lidar_imu_init::msg::Pose6D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose6D_message_member_array[6] = {
  {
    ...
    offsetof(lidar_imu_init::msg::Pose6D, offset_time),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(lidar_imu_init::msg::Pose6D, acc),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(lidar_imu_init::msg::Pose6D, gyr),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(lidar_imu_init::msg::Pose6D, vel),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(lidar_imu_init::msg::Pose6D, pos),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(lidar_imu_init::msg::Pose6D, rot),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pose6D_message_members = {
  ...
  "Pose6D",  // message name
  6,  // number of fields
  sizeof(lidar_imu_init::msg::Pose6D),
...
get_message_type_support_handle<lidar_imu_init::msg::Pose6D>()
{
  return &::lidar_imu_init::msg::rosidl_typesupport_introspection_cpp::Pose6D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_imu_init, msg, Pose6D)() {
  return &::lidar_imu_init::msg::rosidl_typesupport_introspection_cpp::Pose6D_message_type_support_handle;
}
