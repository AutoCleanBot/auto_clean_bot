...
#include "lidar_imu_init/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _States_type_support_symbol_names_t _States_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_imu_init, msg, States)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_imu_init, msg, States)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_lidar_imu_init
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_imu_init, msg, States)() {
  return &::lidar_imu_init::msg::rosidl_typesupport_c::States_message_type_support_handle;
}
