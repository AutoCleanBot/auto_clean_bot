...
static const _Pose6D_type_support_symbol_names_t _Pose6D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_imu_init, msg, Pose6D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_imu_init, msg, Pose6D)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_imu_init, msg, Pose6D)() {
  return &::lidar_imu_init::msg::rosidl_typesupport_c::Pose6D_message_type_support_handle;
}
