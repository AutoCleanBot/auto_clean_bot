...
#ifndef ROS_INFO
#define ROS_INFO(...) RCLCPP_INFO(rclcpp::get_logger("lidar_imu_init"), __VA_ARGS__)
#endif
#ifndef ROS_WARN
#define ROS_WARN(...) RCLCPP_WARN(rclcpp::get_logger("lidar_imu_init"), __VA_ARGS__)
#endif
#ifndef ROS_ERROR
#define ROS_ERROR(...) RCLCPP_ERROR(rclcpp::get_logger("lidar_imu_init"), __VA_ARGS__)
#endif
#ifndef ROS_ASSERT
...
inline double time_to_sec(const builtin_interfaces::msg::Time & stamp)
{
    return rclcpp::Time(stamp).seconds();
}

inline builtin_interfaces::msg::Time sec_to_time(double seconds)
{
    builtin_interfaces::msg::Time stamp;
    int64_t nsec = static_cast<int64_t>(seconds * 1e9);
    if (nsec < 0) {
        stamp.sec = static_cast<int32_t>((nsec - 999999999LL) / 1000000000LL);
        stamp.nanosec = static_cast<uint32_t>(nsec - static_cast<int64_t>(stamp.sec) * 1000000000LL);
    } else {
