 ...
 */
int CinsSerial::TTYSetOpt(int fd, int speed, int databits, int stopbits, char parity) {
 ...
 */
int CinsSerial::TTYOpen(const char *devname) {
...
/**
 * TTYClose - close tty device
 * @fd: the device handle
 *
 */
int CinsSerial::TTYClose(int fd) { 
    return close(fd); 
}
 ...
 *
 */
int CinsSerial::TTYWrite(int fd, char *buf, int size) {
    int wr = -1;
