...
class PointCloudPublisher(Node):
    def __init__(self):
        ...
        # 声明并获取输出话题参数
        self.output_topic = self.declare_parameter('output_topic', '/points').get_parameter_value().string_value
        ...
        self.get_logger().info(f'Publishing to topic: {self.output_topic}')
