...
def upload_to_s3(bucket, artifact, bucket_key):
    ...
    """
    print("Upload {} to {}/{}/{}".format(artifact, "https://s3-us-west-2.amazonaws.com", bucket, bucket_key))
    try:
...
def main():
    ...
    parser.add_argument("--artifact", nargs='+', help="Names of the artifact to be uploaded to S3")
    ...
    for f in args.artifact:
        if not upload_to_s3(args.bucket, f, args.bucket_key + '/' + os.path.basename(f)):
            sys.exit(1)
