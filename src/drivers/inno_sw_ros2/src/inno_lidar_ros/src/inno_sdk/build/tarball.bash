...
BASE_TARBALL_FILES="README.md_SDKdeploy Makefile_SDKdeploy CMakeLists.txt"
INTERNAL_TARBALL_FILES=""

# build
BASE_TARBALL_FILES="$BASE_TARBALL_FILES build/cpplint.py build/*.cmake build/build_unix.sh build/build_win.bat"

# docs
BASE_TARBALL_FILES="$BASE_TARBALL_FILES docs/check_net.md docs/demo.md docs/get_pcd.md docs/HOW_TO_USE_CLIENT_SDK.md"
BASE_TARBALL_FILES="$BASE_TARBALL_FILES docs/innovusion_lidar_util.md docs/innovusion_lua.md"
...
DYNA_LIB_TARBALL_FILES="$DYNA_LIB_TARBALL_FILES src/sdk_common/inno_faults_common.h src/sdk_common/inno_faults_falcon.h src/sdk_common/inno_faults_robinw.h"
...
then
	...
	then
		...
		BASE_TARBALL_FILES="$BASE_TARBALL_FILES build/build_win.bat build/build_mingw.sh apps/tools/get_pcd/get_pcd_ver.rc"
	else
...
then
	...
	INTERNAL_TARBALL_FILES="$INTERNAL_TARBALL_FILES apps/tools/lidar_util/innovusion_lidar_util"
	INTERNAL_TARBALL_FILES="$INTERNAL_TARBALL_FILES apps/tools/parse/parse_pcap apps/tools/parse/parse_pcap.cpp"
	INTERNAL_TARBALL_FILES="$INTERNAL_TARBALL_FILES apps/tools/parse/Makefile apps/tools/parse/CMakeLists.txt"
